...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('SUBMISSION', 'APPROVAL', 'REJECTION', 'PUBLICATION', 'UNPUBLICATION', 'ARCHIVE', 'DRAFT_SAVED', 'REVISION_REQUESTED', 'REVISION_APPROVED', 'REVISION_REJECTED', 'REVISION_CONSUMED', 'ACCOUNT_REQUEST');
...
-- CreateEnum
CREATE TYPE "CategoryTheme" AS ENUM ('DEFAULT', 'MINIMAL', 'MAGAZINE', 'GRID', 'TIMELINE', 'CARDS');
...
CREATE TABLE "Category" (
    ...
    "name" TEXT NOT NULL,
    "slug" TEXT NOT NULL,
    "theme" "CategoryTheme" NOT NULL DEFAULT 'DEFAULT',
    "themeConfig" JSONB,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
