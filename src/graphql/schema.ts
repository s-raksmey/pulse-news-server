  ...
  resolvers: {
    ...
    Query: {
      ...
      listUsers: async (
        ...
        try {
          return await listUsers(input, context.user.id);
        } catch (error) {
      ...
      getUserById: async (
        ...
        try {
          return await getUserById(id, context.user.id);
        } catch (error) {
      ...
      getUserActivity: async (
        ...
        if (userId && context.user?.id !== userId && context.user?.role !== 'ADMIN') {
          throw new Error('Access denied');
        }
    ...
    Mutation: {
      ...
      updateUserProfile: async (
        ...
        try {
          return await updateUserProfile(input, context.user.id);
        } catch (error) {
      ...
      updateUserRole: async (
        ...
        try {
          return await updateUserRole(input, context.user.id);
        } catch (error) {
      ...
      updateUserStatus: async (
        ...
        try {
          return await updateUserStatus(input, context.user.id);
        } catch (error) {
      ...
      deleteUser: async (
        ...
        try {
          return await deleteUser(id, context.user.id);
        } catch (error) {
      ...
      bulkUpdateUserRoles: async (
        ...
        try {
          return await bulkUpdateUserRoles(userIds, role, context.user.id);
        } catch (error) {
      ...
      bulkUpdateUserStatus: async (
        ...
        requireAuth(context);
        // Only admins can bulk update user status
        if (context.user?.role !== 'ADMIN') {
          throw new Error('Admin access required');
        }
        
        try {
          return await bulkUpdateUserStatus(userIds, isActive, context.user.id);
        } catch (error) {
